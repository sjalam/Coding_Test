...
Purpose; To demonstrate data cleanig, running regression and visualisation
*/
...
esttab, cells("mean(fmt(%9.2f))  sd(fmt(%9.2f))") title("Summary Statistics")
...
sum age
// now the mean of age is 44.28  years which is understandable.
/*
If I brows the data there some negative values such as -999 or -555, these 
are missing values but as of provides no information, so recoding these values
as...
*/
...
// here the relationship of household age and their tenure is positive
